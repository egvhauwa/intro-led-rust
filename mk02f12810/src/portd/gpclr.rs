...
pub type GPWD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPCLR_SPEC, u16, u16, 16, O>;
...
pub type GPWE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPCLR_SPEC, u16, GPWE_AW, 16, O>;
