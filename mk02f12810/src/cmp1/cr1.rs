...
pub type TRIGM_R = crate::BitReader<TRIGM_A>;
...
pub type TRIGM_W<'a, const O: u8> = crate::BitWriter<'a, u8, CR1_SPEC, TRIGM_A, O>;
impl<'a, const O: u8> TRIGM_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trigm(&mut self) -> TRIGM_W<5> {
        TRIGM_W::new(self)
    }
    #[doc = "Bit 6 - Windowing Enable"]
    #[inline(always)]
