...
pub type AHSRUN_R = crate::BitReader<AHSRUN_A>;
...
pub type AHSRUN_W<'a, const O: u8> = crate::BitWriter<'a, u8, PMPROT_SPEC, AHSRUN_A, O>;
impl<'a, const O: u8> AHSRUN_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahsrun(&mut self) -> AHSRUN_W<7> {
        AHSRUN_W::new(self)
    }
