...
pub mod sopt1;
#[doc = "SOPT1CFG (r) register accessor: an alias for `Reg<SOPT1CFG_SPEC>`"]
...
pub mod sopt7;
#[doc = "SOPT8 (rw) register accessor: an alias for `Reg<SOPT8_SPEC>`"]
pub type SOPT8 = crate::Reg<sopt8::SOPT8_SPEC>;
