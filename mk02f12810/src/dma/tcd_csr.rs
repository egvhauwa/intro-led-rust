...
pub type MAJORLINKCH_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD_CSR_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    #[doc = "Bits 8:9 - Link Channel Number"]
    #[inline(always)]
    pub fn majorlinkch(&self) -> MAJORLINKCH_R {
        MAJORLINKCH_R::new(((self.bits >> 8) & 3) as u8)
    }
