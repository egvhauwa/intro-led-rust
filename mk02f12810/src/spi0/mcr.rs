...
pub type PCSIS_R = crate::FieldReader<u8, PCSIS_A>;
...
pub type PCSIS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MCR_SPEC, u8, PCSIS_A, 6, O>;
impl<'a, const O: u8> PCSIS_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcsis(&mut self) -> PCSIS_W<16> {
        PCSIS_W::new(self)
    }
    #[doc = "Bit 24 - Receive FIFO Overflow Overwrite Enable"]
    #[inline(always)]
